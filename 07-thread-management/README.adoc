...
[mermaid, target=coordination-patterns, format=svg]
....
graph TD
...
[mermaid, target=rwlock, format=svg]
....
graph LR
    subgraph "Read Lock"
...
[mermaid, target=barrier, format=svg]
....
sequenceDiagram
...
[mermaid, target=thread-local, format=svg]
....
graph TD
...
|Lock wait time
|Time threads spend waiting
|Direct performance loss

|Lock hold time
|Duration lock is held
...
[mermaid, target=cpu-affinity, format=svg]
....
graph LR
...
[mermaid, target=work-stealing, format=svg]
....
graph TD
    subgraph "Thread 1"
...
[source,python]
----
include::02_coordination_patterns.py[]
----
...
[source,python]
----
include::03_performance_debug.py[]
----
...
link:../08-putting-it-together/README.adoc[Module 8: Putting It All Together] - Build a high-performance API server
